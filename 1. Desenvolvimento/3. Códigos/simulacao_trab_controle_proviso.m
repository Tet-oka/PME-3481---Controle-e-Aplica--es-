...
x0 =  [q1_0 q2_0 theta_0 q3_0 q1p_0 q2p_0 thetap_0 q3p_0 pos_ini vel_ini];
  ...
  [t, ycn2] = ode45(@fcn2, tempo, x0, max_step);
  [t, ycn1] = ode45(@fcn1, tempo, x0, max_step);
...
grid on
grid minor
legend('Torque ativo', 'T max', 'T max')
...
% set(p,'FaceAlpha',0.1)
% set(p,'EdgeColor','none')
legend('Original (não linear)','Controlado NL', 'Controlado L')
...
%
function dycndtp2 = fcn2(t, ycnl_0)
phi = 13*pi/180; 
    g = 9.81;
    rho = 1.2923; 
    C_pav = 1; 
...
K26 = -7.8586e+07 ;
    ...
    dycndt9 = ycnl_0(10);
    dycndt10 = (-((M+m)*g - CL*S*rho*((ycnl_0(10)+uv)^2)/2)*(urol) - CD*S*rho*((ycnl_0(10)+uv)^2)/2)/(M+m);
    dycndtp2 = [dycndt1; dycndt2; dycndt3; dycndt4; dycndt5; dycndt6; dycndt7; dycndt8; dycndt9; dycndt10];
end
function dycndtp1 = fcn1(t, ycnl_0)
phi = 13*pi/180; 
    g = 9.81;
    rho = 1.2923; 
    C_pav = 1; 
    ...
    dycndt9 = ycnl_0(10);
    dycndt10 = (-((M+m)*g - CL*S*rho*((ycnl_0(10)+uv)^2)/2)*(urol) - CD*S*rho*((ycnl_0(10)+uv)^2)/2)/(M+m);
    dycndtp1 = [dycndt1; dycndt2; dycndt3; dycndt4; dycndt5; dycndt6; dycndt7; dycndt8; dycndt9; dycndt10];
end
