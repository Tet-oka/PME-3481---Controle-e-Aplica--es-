...
%Controlabilidade
CntrlMatrix = ctrb(Amatrix, Bmatrix);
%UMA VEZ QUE O POSTO DA MATRIZ DE CONTROLABILIDADE CONDIZ COM A ORDEM DO
%SISTEMA (6), O SISTEMA É DITO COMO CONTROLÁVEL

%Observabilidade
ObsvMatrix = obsv(Amatrix, Cmatrix);
%COMO O POSTO DA MATRIZ DE OBSERVABILIDADE É IGUAL À ORDEM DO SISTEMA (n = 6), O SISTEMA É OBSERVÁVEL 
